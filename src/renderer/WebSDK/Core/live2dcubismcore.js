            ...
            return (
              ...
              (n[4] = function (a, mh) {
                ...
                if (
                  ...
                  (rh = (function (a, ji) {
                    ...
                    (oh = (ph + q[(a + 284) >> 2]) | 0),
                    (u[oh >> 2] =
                      u[oh >> 2] + x(x(rh * x(-180)) / x(3.1415927410125732))),
                    (qh = q[(qh + 8) >> 2] << 2),
                    (u[((oh = mh << 2) + wh) >> 2] =
              ...
              (n[11] = function (a, Il, Rm, Sm, Tm, Um) {
                ...
                if (
                  ...
                  if (
                    ((en = (dn = 32 & Um) ? (kn + 9) | 0 : kn),
                    !(11 < Sm >>> 0) && (Vm = (12 - Sm) | 0))
                  ) {
                    for (gn = 8; ; )
                      if (((gn *= 16), !(Vm = (Vm + -1) | 0))) break;
                ...
                if (8 == (0 | v)) v = qa($);
                  ...
                  v = (function (a, Vk) {
                    ...
                    if (((tl = a >>> 0 > (ql = 16) ? a : 16) + -1) & tl) {
                      for (;;)
                        if (((ql = (a = ql) << 1), !(a >>> 0 < tl >>> 0)))
                          break;
                    } else a = tl;
                    if ((-64 - a) >>> 0 <= Vk >>> 0) return (q[2086] = 48), 0;
                    if (
                      !(ql = qa(
                        (12 +
                          (((tl = Vk >>> 0 < 11 ? 16 : (Vk + 11) & -8) + a) |
                            0)) |
                          0,
                      ))
                    )
              ...
              if (
                (!(function (a) {
                  ...
                  q[(a + 428) >> 2] &&
                    ((Wg = q[(a + 332) >> 2]),
                    (Vg = Wg << 2),
                    $(q[(a + 460) >> 2], q[(a + 436) >> 2], Vg),
                    $(q[(a + 464) >> 2], q[(a + 440) >> 2], Vg),
                    $(q[(a + 468) >> 2], q[(a + 448) >> 2], Vg),
                    r[(q[a >> 2] + 4) | 0] < 4 ||
                      ((Vg = Wg << 4),
                      $(q[(a + 472) >> 2], q[(a + 452) >> 2], Vg),
                            ...
                            o: if (4 <= r[(a + 4) | 0]) {
                              ...
                              for (am = 0; ; ) {
                                if (
                                  ...
                                  1 <=
                                    ((Il = 0) |
                                      (Jl = q[(gm + q[(dm + 952) >> 2]) >> 2])))
                                )
                                  for (
                                    fm = q[(gm + q[(dm + 948) >> 2]) >> 2],
                                      im = (Jl + fm) | 0,
                                      jm = q[(dm + 1060) >> 2],
                                      km = q[(dm + 1056) >> 2];
                                    ;
                      ...
                      if (pb) {
                        ...
                        e: {
                          if (
                            ...
                            (rb = q[2088] & dd(lb)), (q[8352 >> 2] = rb);
                            break b;
                          }
                          if (
                            !(q[
                              (pb + (q[(pb + 16) >> 2] == (0 | a) ? 16 : 20)) >>
                                2
                            ] = _a)
                          )
                            break b;
              ...
              a: {
                ...
                if (
                  ...
                  (Ob = x(
                    Kb *
                      x(
                        x(Kb * x(-0.106480173766613)) + x(-0.19999158382415771),
                      ),
                  )),
                  (Kb = x(
                    Nb *
                      ...
                      (Qb = (function (a, Il, Jl) {
                        ...
                        a: {
                          for (;;) {
                            ...
                            (Kl = ja(Kl, Pl)),
                              (Kl += -8 * C(0.125 * Kl)),
                              (Ql = y(Kl) < 2147483648 ? ~~Kl : -2147483648),
                              (Kl -= 0 | Ql);
                            e: {
                              f: {
                                g: {
